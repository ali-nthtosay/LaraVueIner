...
<div class="flex justify-center mt-10">
    ...
    <div v-if="sentMessage" id="toast-simple" class=" flex  w-full max-w-xs p-4 space-x-4 rtl:space-x-reverse text-gray-500 bg-white divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
    ...
    <div class="ps-4 text-sm font-normal">Comment sent successfully.</div>
    </div>
</div>

<div class="flex justify-center mt-10">
    <div v-if="erroMessage" id="toast-danger" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    ...
    <div class="border border-gray-300 p-4 rounded-lg max-w-xl mx-auto mt-20">
      ...
      <form @submit.prevent="submitForm" v-on:keyup.enter.prevent="submitForm">
        ...
        <label class="block text-gray-700 font-medium mb-2" for="name">E-mail(optional)</label>
